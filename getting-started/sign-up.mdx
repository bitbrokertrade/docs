---
title: "Sign up for BitBrokerTrade: create an account and start"
...
<CardGroup cols={2}>
  <Card title="First login and menu" icon="compass" href="/en/getting-started/first-login-and-menu">
    Discover the menu structure and set your profile preferences.
  </Card>

  <Card title="Connect exchanges" icon="link" href="/en/exchanges/what-is-an-exchange">
