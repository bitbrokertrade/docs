...
description: "From sign-up to first automated trade: discover how BitBrokerTrade goes to work for you in five steps with your own crypto account."
---
...
<Steps>
  <Step title="Sign up with BitBrokerTrade">
    ...
    Once you are logged in, you see the dashboard and the menu sections that guide you through the next steps. Want to know what you will see after logging in? Read [First login and menu](/en/getting-started/first-login-and-menu).

    <Tip>
      Don't have an account yet? Go to the [sign-up page](/en/getting-started/sign-up) and register within five minutes.
    </Tip>
  </Step>
  <Step title="Create an account at an exchange">
    ...
    <CardGroup cols={3}>
      <Card title="Bitvavo" icon="building-columns" href="/en/exchanges/bitvavo">
      </Card>

      <Card title="Binance" icon="building-columns" href="/en/exchanges/binance">
      </Card>

      <Card title="Bybit" icon="building-columns" href="/en/exchanges/bybit">
      </Card>

      <Card title="Bitstamp" icon="building-columns" href="/en/exchanges/bitstamp">
      </Card>

      <Card title="Coinbase" icon="building-columns" href="/en/exchanges/coinbase">
      </Card>

      <Card title="KuCoin" icon="building-columns" href="/en/exchanges/kucoin">
      </Card>
    </CardGroup>
  ...
  <Step title="Connect BitBrokerTrade to the exchange">
    ...
    You request an API key through your exchange account settings and then enter it in BitBrokerTrade under **Settings → Exchanges → Add exchange**. Detailed instructions per exchange are available in the [Exchanges](/en/exchanges/what-is-an-exchange) chapter.
  ...
  <Step title="Configure the trader">
    Set the parameters for the trader in the **Traders** menu. This includes, for example, the minimum return percentage a position must reach before the trader sells. More explanation about all settings is available on the [Trader settings](/en/traders/trader-settings) page.
    ...
    <Accordion title="How does the MACD method work?">
      ...
      Read more on the [Trading strategy](/en/traders/trading-strategy) page.
    </Accordion>
  ...
  <Step title="Start earning">
    ...
    <CardGroup cols={2}>
      <Card title="View dashboard" icon="chart-line" href="/en/getting-started/dashboard">
...
<CardGroup cols={2}>
  <Card title="What is an exchange?" icon="circle-question" href="/en/exchanges/what-is-an-exchange">
    More explanation about crypto exchanges and which one suits you.
  </Card>

  <Card title="What is a trader?" icon="circle-question" href="/en/traders/what-is-a-trader">
    Everything about how the trader software works and what to expect.
  </Card>

  <Card title="Pricing and credits" icon="circle-question" href="/en/introduction/pricing-and-credits">
    How does the no-cure-no-pay system work and how many credits do you need?
  </Card>

  <Card title="FAQ general" icon="circle-question" href="/en/faq/general">
