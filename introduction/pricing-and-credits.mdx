...
description: "BitBrokerTrade works on a commission basis: you pay 20% of your gross return through a prepaid credits system. No return, no cost."
---
...
<CardGroup cols={2}>
  ...
  <Card title="FAQ: returns and profit" icon="circle-question" href="/en/faq/returns-and-profit">
  ...
  <Card title="Referral program" icon="users" href="/en/other/referral-program">
